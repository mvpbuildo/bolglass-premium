                ...
                <div className="flex justify-between h-16">
                    <div className="flex items-center gap-8">
                        ...
                        <div className="hidden md:flex space-x-8">
                            ...
                            <Link
                                href="/rezerwacja"
                                className={`inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium ${isActive('/rezerwacja') ? 'border-red-500 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
                            >
                                Warsztaty
                            </Link>
                            <Link
                        ...
                        {session ? (
                            <div className="flex items-center gap-2">
                                {session.user?.role === 'ADMIN' && (
                                    <Link href="/admin">
                                        <Button variant="ghost" size="sm" className="hidden sm:flex text-red-600 font-bold">
                                            Panel Admina
                                        </Button>
                                    </Link>
                                )}
