...
export default async function AdminProductsPage() {
    ...
    try {
        ...
        console.log(`AdminProductsPage - found ${products.length} products`);
        ...
        return (
            <main className="min-h-screen bg-gray-50 py-12">
                <div className="max-w-6xl mx-auto px-4 text-center">
                    <h2 className="text-2xl font-bold text-red-600 mb-4">Wystąpił błąd podczas ładowania produktów</h2>
                    <p className="text-gray-600 mb-8">{error instanceof Error ? error.message : "Błąd bazy danych"}</p>
                    <Link href="/admin">
