                        ...
                        <div className="space-y-16">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-12">
                                <section className="space-y-6">
                                    <h2 className="text-amber-500 font-black text-[10px] uppercase tracking-[0.3em] opacity-40">{t('location')}</h2>
                                ...
                                <section className="space-y-6">
                                    <h2 className="text-amber-500 font-black text-[10px] uppercase tracking-[0.3em] opacity-40">{t('contact')}</h2>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-12 pt-12 border-t border-white/5">
                                <section className="space-y-6">
                                    <h2 className="text-amber-500 font-black text-[10px] uppercase tracking-[0.3em] opacity-40">{t('hours')}</h2>
                                    <div className="flex gap-4">
                                        ...
                                        <div className="space-y-1">
                                            <p className="font-serif text-xl text-amber-50 leading-tight">{t('weekdays')}</p>
                                ...
                                {(contactInfo.fb || contactInfo.ig) && (
                                    <section className="space-y-6">
                                        <h2 className="text-amber-500 font-black text-[10px] uppercase tracking-[0.3em] opacity-40">{t('socialMedia')}</h2>
                                        <div className="flex gap-4">
                                            {contactInfo.fb && (
                            ...
                            <div className="relative rounded-[2rem] overflow-hidden border border-white/5 bg-white/5 backdrop-blur-xl group h-full shadow-2xl">
                                {contactInfo.map ? (
                                    ...
                                    <div className="flex flex-col items-center justify-center h-full text-amber-500/20">
                                        ...
                                        <p className="font-serif text-lg italic">{t('mapPlaceholder')}</p>
                                    </div>
                                )}
                    ...
                    <div id="rezerwacja" className="relative group">
                        ...
                        <div className="relative bg-white/5 border border-white/5 backdrop-blur-2xl rounded-[2.5rem] overflow-hidden shadow-2xl">
                            <div className="bg-gradient-to-r from-amber-500/10 via-amber-500/5 to-transparent p-12 text-center border-b border-white/5">
                                <h2 className="text-4xl md:text-5xl font-serif text-amber-50 mb-4">{t('bookTitle')}</h2>
                                <p className="text-amber-200/40 text-lg font-light italic">{t('bookSubtitle')}</p>
                            </div>
                            ...
                            <div className="bg-black/20 p-8 border-t border-white/5 text-center">
                                <p className="text-sm text-amber-200/40 font-light italic">
                                    {t('groupBooking')} <a href={`tel:${contactInfo.phones[0]}`} className="text-amber-500 font-black hover:text-amber-400 transition-colors uppercase tracking-widest text-xs ml-2">{t('callUs')}</a>
                                </p>
                            </div>
                        </div>
                    </div>
